...
def spider(url, tag):
	...
	f = open(BASE_DIR + '/tgong_contents.html', 'w')
	f.write(plain_text)
	f.close()
...
#url = "http://www.g2b.go.kr:8340/search.do?kwd=%B3%BB%C1%F8&category=TGONG&subCategory=ALL&detailSearch=false&reSrchFlag=false&pageNum=1&sort=R&srchFd=ALL&date=&startDate=&endDate=&year=&orgType=balju&orgName=&orgCode=&swFlag=&dateType=&area=&gonggoNo=&preKwd=&preKwds="

#url = "http://www.g2b.go.kr:8340/body.do?kwd=%B3%BB%C1%F8&category=TGONG&subCategory=ALL&detailSearch=false&reSrchFlag=false&pageNum=1&sort=R&srchFd=ALL&date=&startDate=&endDate=&year=&orgType=balju&orgName=&orgCode=&swFlag=&dateType=&area=&gonggoNo=&preKwd=&preKwds="

'''
## 용역 입찰공고 상세 전체
url = "http://www.g2b.go.kr:8340/link.do?kwd=%B3%BB%C1%F8&category=TGONG&subCategory=ALL&detailSearch=false&sort=R&reSrchFlag=false&pageNum=1&srchFd=ALL&date=&startDate=&endDate=&orgType=balju&orgName=&orgCode=&swFlag=Y&dateType=&area=&gonggoNo=&val1=20180517798&val2=00&type=1&target=%BF%EB%BF%AA"
'''



## 용역 입찰공고 상세 content!!
url = "http://www.g2b.go.kr:8081/ep/invitation/publish/bidInfoDtl.do?bidno=20180517798&bidseq=00&releaseYn=Y&taskClCd=5"


'''
	        	<tr>
	            	<th><p>배정예산</p></th>
	            	<td><div class="tb_inner">70,444,000원</div></td>
	            	<th><p>추정가격</p></th>
	            	<td><div class="tb_inner">64,040,000원</div></td>
	       		</tr>
...
for title in spider(url, 'tr'):
	...
	#data['key'].append(title.find('p', {'text': '배정예산'}))
	#data['val'].append(title.find({'text': '배정예산'}).next_siblings)
	#data['val'].append(title.find('td').string)
