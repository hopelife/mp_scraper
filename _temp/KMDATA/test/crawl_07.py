...
def get_url(tpl):
	...
	if js == "showGcPostLinkView":
		url = "http://www.g2b.go.kr:8340/link.do?kwd=내진 성능평가&category=GC&subCategory=ALL&detailSearch=false&sort=R&reSrchFlag=false&pageNum=1&srchFd=ALL&date=&startDate=&endDate=&orgType=balju&orgName=&orgCode=&swFlag=Y&dateType=&area=&gonggoNo="
		add = "&val1=" + param[0] + "&val2=" + param[1] + "&val3=" + param[2] + "&seq=" + param[3] + "&type=" + param[4] +  "&div=" + param[5] + "&target=" + param[6]

	elif js == "showGcLinkView":
		url = "http://www.g2b.go.kr:8340/link.do?kwd=내진 성능평가&category=GC&subCategory=ALL&detailSearch=false&sort=R&reSrchFlag=false&pageNum=1&srchFd=ALL&date=&startDate=&endDate=&orgType=balju&orgName=&orgCode=&swFlag=Y&dateType=&area=&gonggoNo="
		add = "&val1=" + param[0] + "&val2=" + param[1] + "&val3=" + param[2] + "&seq=" + param[3] + "&type=" + param[4] + "&target=" + param[5]
...
'''
<li>
	<span class="cate1">용역</span>
	<span class="cate2">
	</span>
	<strong class="tit">
					<a href="javascript:showGcPostLinkView('20070516090','01','','1','1','1','용역')">
					<span class="num">[20070516090-01]</span>
					김포공항 도심항공화물터미널(3 ... 정밀안전진단 ...</a>
	</strong>
		<a href="#self" class="btn_toggle">펼치기</a>
	<span class="date"><strong>수요기관</strong>
	한국공항공사
	</span>
'''
