...
# base_path = '_scrap/wikidocs/110_파이썬으로 배우는 알고리즘 트레이딩 (개정판-2쇄)/source/'  ## 'https://wikidocs.net/book/110'
base_path = '../../../__references/_python/sats/_scrap/wikidocs/110_파이썬으로 배우는 알고리즘 트레이딩 (개정판-2쇄)/source/'  ## 'https://wikidocs.net/book/110'
base_url = 'https://wikidocs.net/'
url = 'https://wikidocs.net/book/110'
