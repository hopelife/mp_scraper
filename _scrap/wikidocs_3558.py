...
base_path = '../../../__references/_python/sats/_scrap/wikidocs/3558_개발자가 데이터 분석 준전문가 되기/source/'  ## 'https://wikidocs.net/book/3558'
base_url = 'https://wikidocs.net/'
url = 'https://wikidocs.net/book/3558'
defaults = dict(
    base_url = base_url,
    base_path = base_path, 
    head = {
